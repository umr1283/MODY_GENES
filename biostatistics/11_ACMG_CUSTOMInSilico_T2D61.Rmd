---
title: 'MODY_GENES Report 8 Gene Monogenique CUSTOM T2D61'
subtitle: 'Group of genes: "CUSTOM_T2Dmono_CCDiabete" / "ACMG-CUSTOM InSilico" '
...
params:
  ...
  res_dir: './/Data/11_ACMG_CUSTOMInSilico_T2D61/000-RESULTS/'
  max_signif: 50
...
workingdir <- ".//Data/11_ACMG_CUSTOMInSilico_T2D61/"

CustomFile <- ".//Docs/CUSTOM_files/custom_22072020.xlsx"
InfoCUSTOM <- read_excel(path = CustomFile, sheet = 1, col_names = TRUE, col_types = "text")

list_transcripts <- list_transcripts %>%
  filter(gene_name %in% InfoCUSTOM$Gene)
```
